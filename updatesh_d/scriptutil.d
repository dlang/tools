...
import std.file:mkdir,exists,isDir,File,dirSeparator;
import std.process:executeShell;
import std.string:strip,indexOf,munch;
...
{
	if (path.length==0)
		throw new Exception("mkdTempInternal: trying to create directory in empty path");
